...
class DetailsAdapter(val identifier: String?) :
    ListAdapter<Sticker, DetailsAdapter.ItemViewHolder>(DiffCallbackDetails()) {
...
class DiffCallbackDetails : DiffUtil.ItemCallback<Sticker>() {
